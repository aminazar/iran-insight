...
class SearchSystem {
  ...
  callFunctions(el, queryObject, offset, pageSize) {
    ...
    switch (el) {
      case 'person': {
        ...
        break;
      case 'business': {
        return this.searchOnBusiness(query, options.tag_search, showAll, offset, pageSize);
      }
        break;
      case 'product': {
        return this.searchOnProduct(query, options.tag_search, showAll, offset, pageSize);
      }
        break;
      case 'organization': {
        return this.searchOnOrganization(query, options.tag_search, showAll, offset, pageSize);
      }
        break;
      case 'lce': {
        ...
        break;
      case 'event': {
        return this.searchOnEvent(query, options.relatedTo, options.start_date, options.end_date, showAll, offset, pageSize);
      }
        break;
      case 'expertise': {
  ...
  searchOnBusiness(phrase, tagSearch, showAll, offset, pageSize) {
    if(tagSearch)
      return this.searchOnEntityTags('business', 'bid', phrase, offset, pageSize);

    return new Promise((resolve, reject) => {
      this.searchSqlTable.searchOnBusiness({
        phrase: phrase,
        tag_search: tagSearch ? tagSearch : null,
        show_all: showAll,
        limit: pageSize ? pageSize : limitation,
        offset: offset
      })
  ...
  searchOnProduct(phrase, tagSearch, showAll, offset, pageSize) {
    if(tagSearch)
      return this.searchOnEntityTags('product', 'product_id', phrase, offset, pageSize);
  ...
  searchOnOrganization(phrase, tagSearch, showAll, offset, pageSize) {
    if(tagSearch)
      return this.searchOnEntityTags('organization', 'oid', phrase, offset, pageSize);
  ...
  searchOnEvent(phrase, relatedTo, start_date, end_date, showAll, offset, pageSize) {
    return new Promise((resolve, reject) => {
      this.searchSqlTable.searchOnEvent({
        ...
        related_to_name: relatedTo ? relatedTo.name : null,
        show_all: showAll,
        limit: pageSize ? pageSize : limitation,
        offset: offset
      })
  ...
  searchOnEntityTags(tableName, idColumn, phrase, offset, pageSize) {
    return this.searchSqlTable.searchOnEntityTags({
      tableName: tableName,
      idColumn: idColumn,
      phrase: phrase,
      offset: offset,
      ...
      .then(res => Promise.resolve({target: tableName, value: res}));
  }
