...
class SearchSystem {
  ...
  callFunctions(el, queryObject, offset) {
    ...
    switch (el) {
      ...
      case 'consultancy': {
        ...
        break;
      case 'type': {
        return this.searchOnType(query, showAll, offset);
      }
      default:
        return null;
        break;
  ...
  searchOnType(phrase, showAll, offset) {
    return new Promise((resolve, reject) => {
      this.sqlTable.searchOnType({phrase: phrase, show_all: showAll, limit: limitation, offset: offset})
