...
function addAndLoginPerson(username, password='123456', extraData = {}) {
  return new Promise((resolve, reject) => {
    let pid, rpJar;
...
function addOrgPerson(username, oid, extraData) {
  ret = {};
  return addPerson(username, '123', {firstname: username+'f', surname: username+'s'})
    .then(res => {
      ret.pid = +res;
