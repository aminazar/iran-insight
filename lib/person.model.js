...
class Person extends SqlTable {
    ...
    return new Promise((resolve, reject) => {
      ...
      relatedFunction
        ...
        .then(res => {
          ...
          let msg = {
            from: person,
            about: Notification.get().getNotificationCategory().IntroducingRep,
            aboutData: {
          ...
          res.forEach(el => Notification.get().pushNotification(msg, {pid: el.pid}));
    ...
    return new Promise((resolve, reject) => {
      ...
      this.whichPerson(data.pid ? parseInt(data.pid) : null, actor.pid, data.bid ? data.bid : null, data.oid ? data.oid : null)
        ...
        .then((res) => {
          let msg = {
            from: actor.pid,
            about: Notification.get().getNotificationCategory().UserUpdateProfile,
            aboutData: {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.getUserAccess(user.pid, body.pid).then(res => {
        ...
        .then(res => {
          let msg = {
            from: user.pid,
            about: Notification.get().getNotificationCategory().UserAddExpertise,
            aboutData: {
  ...
  deleteExpertise(user, body) {
    return new Promise((resolve, reject) => {
      ...
      this.getUserAccess(user.pid, body.pid).then(res => {
        ...
        let msg = {
          from: user.pid,
          about: Notification.get().getNotificationCategory().UserRemoveExpertise,
          aboutData: {
            person_name: (user.firstname_en ? user.firstname_en : user.firstname_fa) + ' ' + (user.surname_en ? user.surname_en : user.surname_fa),
            ...
            this.sql.partnership.add(body)
              .then(() => {
                if (!res.isAdmin) {
                  let msg = {
                    from: user,
                    about: Notification.get().getNotificationCategory().PersonRequestPartnership,
                    aboutData: {
                      person_name: (user.firstname_en ? user.firstname_en : user.firstname_fa) + ' ' + (user.surname_en ? user.surname_en : user.surname_fa),
                  ...
                  Notification.get().pushNotification(msg, {pid: body.pid2});
          ...
          if (res.isAdmin || res.isUser) { // user himself or admin is confirming a partnership
            if (body.is_confirmed)
              this.sql.partnership.update({is_confirmed: body.is_confirmed}, body.id)
                .then(res => {
                  updateId = res;
                  return this.sql.partnership.getFullData({id: body.id});
                })
                .then(res => {
                  let msg = {
                    from: user,
                    about: Notification.get().getNotificationCategory().PersonConfirmPartnership,
                    aboutData: {
                  ...
                  let msg_broadcast = {
                    from: res[0],
                    about: Notification.get().getNotificationCategory().PeopleAddPartnership,
                    aboutData: {
                  ...
                  Notification.get().pushNotification(msg, {pid: res[0].pid1});
              ...
              this.sql.partnership.getFullData({id: body.id})
                .then(res => {
                ...
                .then(res => {
                  let msg = {
                    from: user,
                    about: Notification.get().getNotificationCategory().PersonRejectPartnershipRequest,
                    aboutData: {
                      person_name: (user.firstname_en ? user.firstname_en : user.firstname_fa) + ' ' + (user.surname_en ? user.surname_en : user.surname_fa),
                  ...
                  Notification.get().pushNotification(msg, {pid: partnershipDetails.pid1});
  ...
  deletePartnership(user, body) {
    return new Promise((resolve, reject) => {
      this.sql.partnership.getFullData({id: body.id}).then(partnership => {
          ...
          if (res.isAdmin || res.isUser) { // pid1 is deleting partnership
            ...
            this.sql.partnership.delete(body.id)
              .then(res => {
                let msg = {
                  from: user,
                  about: Notification.get().getNotificationCategory().PersonRemovePartnership,
                  aboutData: {
                    person_name: (user.firstname_en ? user.firstname_en : user.firstname_fa) + ' ' + (user.surname_en ? user.surname_en : user.surname_fa),
                ...
                Notification.get().pushNotification(msg, {pid: partnership[0].pid2});
                Notification.get().pushNotification(msg);
        ...
        .then(() => {
          curSql.membership.getBizOrgNameById({mid: mid})
            .then(res => {
              let msg = {
                from: user,
                about: Notification.get().getNotificationCategory().AcceptRepRequest,
                aboutData: {
                  person_name: (user.firstname_en || user.firstname_fa) + ' ' + (user.surname_en || user.surname_fa),
                  person_username: user.username,
              ...
              let msg_broadcast = {
                from: user,
                about: Notification.get().getNotificationCategory().UpdateBusinessOrganizationRep,
                aboutData: {
                  person_name: (user.firstname_en || user.firstname_fa) + ' ' + (user.surname_en || user.surname_fa),
                  person_username: user.username,
                  org_biz_name: res[0].name || res[0].name_fa,
              ...
              Notification.get().pushNotification(msg, {pid: res[0].pid});
              Notification.get().pushNotification(msg_broadcast);
            });
        ...
        .then(() => {
          ...
          curSql.membership.getBizOrgNameById({mid: mid})
            .then(res => {
              let msg = {
                from: user,
                about: Notification.get().getNotificationCategory().RejectRepRequest,
                aboutData: {
                  person_name: (user.firstname_en || user.firstname_fa) + ' ' + (user.surname_en || user.surname_fa),
                  person_username: user.username,
                  org_biz_name: res[0].name || res[0].name_fa,
