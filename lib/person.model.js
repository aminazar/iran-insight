  ...
  static deleteRepAndHisCompany(mid) {
    ...
    return new Promise((resolve,reject) => {
      ...
      curSql.membership.getWithAssoc({mid: mid})
        .then((res) => {
          assocMemberObj.mid = res[0].mid;
          assocMemberObj.assoc_id = res[0].assoc_id;
          assocMemberObj.bid = res[0].bid;
          assocMemberObj.oid = res[0].oid;
          assocMemberObj.pid = res[0].pid;
