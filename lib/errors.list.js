...
let notBizRep = new Error('User is not representative of business that owns the event');
notBizRep.status = 403;

let notOrgRep = new Error('User is not representative of organization that owns the event');
