...
describe("REST API", () => {
    ...
    //         req.post({
    //             url: base_url + 'user/' + uid + test_query,
    ...
    //         req.put({
    //             url: base_url + 'user' + test_query,
    //             form: {username: 'ali', password: 'tes'}
    //         }, function (err, res) {
    //             if (resExpect(res, 200)) {
    ...
    //     afterEach((done) => {
    //         if (uid && teardown)
    //             sql.test.users.drop().then(() => done()).catch(err => {
    //                 console.log(err.message);
    //                 done()
    //             });
    //         else done();
